...
@InputType()
class ContractPerformanceCreateNestedManyWithoutContractsInput {
...
export { ContractPerformanceCreateNestedManyWithoutContractsInput as ContractPerformanceCreateNestedManyWithoutContractsInput };
